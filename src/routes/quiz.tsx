...
const questions = [
  {
    ...
    answers: [
      { answer: "Drive Alone", points: 2 },
      { answer: "Take public transport", points: 2 },
      { answer: "Ride with friends", points: 2 },
  ...
  },
  {
    ...
    answers: [
      { answer: "Affordability", points: 3 },
      { answer: "Convenience", points: 2 },
      { answer: "Environmental Sustainability", points: 1 },
  ...
  },
  {
    ...
    answers: [
      { answer: "Yes, I enjoy sharing rides", points: 1 },
      { answer: "No, I like to ride alone", points: 4 },
    ],
